 ...
 */
print("The above code does compile, because a variable can be changed to a new value after it is initialized, unlike a constant, which remains fixed to it's initial value.")
